...
const ProfilePage: NextPage<IProfileProps> = (props) => {
        ...
        <div className="profile-header paper">
          <div className="profile-header__wrap">
            ...
            <div className="profile-actions">
              <a href="#" className="button button_sm" title="Изменить настройки">
          ...
          <div className="profile-nav">
            <div className="profile-nav__list tabs-list">
              <a href="#" className="profile-nav__item tabs__item tabs__item_active">
                Списки
              </a>
        ...
        <div className="bookmark">
              ...
              <div className="bookmark-sidebar__panel">
                <div className="bookmark-menu">
                  <div className="bookmark-menu__item">
                    <span className="bookmark-menu__label text-truncate">Все</span>
                    <span className="bookmark-menu__value">1</span>
                  </div>
                  <div className="bookmark-menu__item bookmark-menu__item_active">
                    <span className="bookmark-menu__label text-truncate">Читаю</span>
                    <span className="bookmark-menu__value">1</span>
                  </div>
                  <div className="bookmark-menu__item">
                    <span className="bookmark-menu__label text-truncate">В планах</span>
                    <span className="bookmark-menu__value">0</span>
                  </div>
                  <div className="bookmark-menu__item">
                    <span className="bookmark-menu__label text-truncate">Брошено</span>
                    <span className="bookmark-menu__value">0</span>
                  </div>
                  <div className="bookmark-menu__item">
                    <span className="bookmark-menu__label text-truncate">Прочитано</span>
                    <span className="bookmark-menu__value">0</span>
                  </div>
                  <div className="bookmark-menu__item">
                    <span className="bookmark-menu__label text-truncate">Любимые</span>
                    <span className="bookmark-menu__value">0</span>
                  </div>
          ...
          <div className="bookmark-wrapper">
            ...
            <div className="bookmark-actions">
              <div className="bookmark-actions__edit text-muted">Множественное редактирование</div>
            </div>
                  ...
                  <div className="bookmark-item__content">
                    <div className="bookmark-item__info">
                      ...
                      <div className="bookmark-item__info-footer">
                        <span className="bookmark-item__continue text-muted">Продолжить [1-1]</span>
                      </div>
                    </div>
