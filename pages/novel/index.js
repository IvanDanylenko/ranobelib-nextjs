          ...
          <div className="media-container">
            <div className="media-sidebar">
              ...
              <div className="media-info-list paper">
                ...
                <div href="#" className="media-info-list__item" target="_blank">
            ...
            <div className="media-content media-content_side">
              <div className="media-name section">
                <div className="media-name__body">
                  <div className="media-name__main text-truncate">
                    Мастер Веры в Себя (Новелла)
                  </div>
                  <div className="media-name__alt text-truncate">
                    Master of Self-Belief
                  </div>
                </div>
                  ...
                  <div className="media-section media-section_info">
                    <div className="media-description media-description_short">
                      <div className="media-description__text">
                        После смерти младшей сестры Ки Чжен По, его родители
                        стали слишком сильно опекать своего уже единственного
                        ребёнка, не понимая, что таким образом только
                        ограничивали его во всех планах.
                        <br />
                        <br />
                        Услышав, что компания "Новокорп" анонсировали первую
                        игру в виртуальной реальности, которая давала чувство
                        полного погружения, ГГ понял, что это его единственный
                        шанс выбраться из этого унылого мира.
                        <br />
                        <br />
                        Но он ещё не понимал, что его мир был не таким уж и
                        плохим местом, так как по ошибке системы его перенесло в
                        самую опасную точку континента, где каждая букашка могла
                        за секунды убить паренька.
                        <br />
                        <br />
                        Да и вообще оказалось, что это и не игра вовсе. Но наш
                        юный друг не зная об этом, слепо верил в своё бессмертие
                        и искал ещё больше риска и опасности, за все годы,
                        которые он не мог это сделать в реальном мире.
                      </div>
                      <button className="media-description__expand">
                        Подробнее...
                      </button>
                    </div>
                    ...
                    <div className="media-section__column">
                      ...
                      <div className="media-stats">
                        <div className="media-stats__item">
                          ...
                          <div className="media-stats__column media-stats__percent">
                            33.3%
                          </div>
                          <div className="media-stats__column media-stats__count">
                            12
                          </div>
                        </div>
                        <div className="media-stats__item">
                    ...
                    <div className="media-chapters__list">
                      <div className="media-chapter media-chapter_new">
                        ...
                        <div className="media-chapter__actions">
                          <a
                            href="#"
                            className="media-chapter__icon media-chapter__icon_edit"
                          >
