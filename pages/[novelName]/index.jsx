                ...
                <div className="media-section media-section_info">
                  <div className="media-description media-description_short">
                    <div className="media-description__text">
                      После смерти младшей сестры Ки Чжен По, его родители стали
                      слишком сильно опекать своего уже единственного ребёнка,
                      не понимая, что таким образом только ограничивали его во
                      всех планах.
                      <br />
                      <br />
                      Услышав, что компания "Новокорп" анонсировали первую игру
                      в виртуальной реальности, которая давала чувство полного
                      погружения, ГГ понял, что это его единственный шанс
                      выбраться из этого унылого мира.
                      <br />
                      <br />
                      Но он ещё не понимал, что его мир был не таким уж и плохим
                      местом, так как по ошибке системы его перенесло в самую
                      опасную точку континента, где каждая букашка могла за
                      секунды убить паренька.
                      <br />
                      <br />
                      Да и вообще оказалось, что это и не игра вовсе. Но наш
                      юный друг не зная об этом, слепо верил в своё бессмертие и
                      искал ещё больше риска и опасности, за все годы, которые
                      он не мог это сделать в реальном мире.
                    </div>
